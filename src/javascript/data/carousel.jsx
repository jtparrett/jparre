...
import 'images/banner-12.jpg'

export default
  [() => (<CarouselImage src={ ['/assets/images/banner-12.jpg'] } />),
  ...
  active => (<CarouselVideo active={active} src="https://www.facebook.com/JParreApparel/videos/593954704148136" />), 
  () => (<CarouselImage src={ ['/assets/images/banner-3.jpg', '/assets/images/banner-4.jpg', '/assets/images/banner-5.jpg'] } />), 
  active => (<CarouselVideo active={active} src="https://www.facebook.com/JParreApparel/videos/593000240910249" />), 
  () => (<CarouselImage src={ ['/assets/images/banner-6.jpg', '/assets/images/banner-7.jpg'] } />), 
  active => (<CarouselVideo active={active} src="https://www.facebook.com/JParreApparel/videos/566298463580427" />), 
